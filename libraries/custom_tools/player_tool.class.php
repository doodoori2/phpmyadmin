...
class player_tool
{
	public function entry()
	{
		...
		$items = array();
		$items[] = array("url" => $_SERVER['PHP_SELF'].PMA_URL_getCommon(array("view" => "play_data")), "name" => "Play Data");
        $items[] = array("url" => $_SERVER['PHP_SELF'].PMA_URL_getCommon(array("view" => "log_data")), "name" => "Log Data");
